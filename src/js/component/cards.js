...
export const CentralCard = () => {
    return (
        ...
        <div className="card w-100" style={{"backgroundColor":"#D9D9D9", "color":"#796666","minHeight":"20rem"}}>
...
export const DestacadosCard = () => {
    return (
        <div className="card w-100 " style={{"minHeight":"20rem" , "backgroundColor":"#D9D9D9", "color":"#796666"}}>
